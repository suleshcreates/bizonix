    ...
    workflow: [
      {
        ...
        alt: "Franchise manager planning retail operations.",
      },
      {
        order: "02",
        ...
        alt: "Team preparing inventory for franchise allocation.",
      },
      {
        order: "03",
        ...
        image: "/images/industries/overview/franchise-operations.webp",
        alt: "Franchise outlet receiving operational stock.",
      },
      {
        order: "04",
        title: "Local selling",
        ...
        image: "/images/industries/overview/franchise-networks.webp",
        alt: "Franchise retail staff operating a store.",
      },
      {
        order: "05",
        ...
        image: "/images/industries/overview/franchise-operations.webp",
        alt: "Franchise team coordinating stock movement.",
      },
      {
        order: "06",
        ...
        image: "/images/industries/overview/franchise-networks.webp",
        alt: "Franchise manager reviewing a multi-outlet operation.",
      },
    ],
    proof: {
    ...
    workflow: [
      {
        ...
        alt: "Jewellery associate receiving organised trays of imitation jewellery.",
      },
      {
        order: "02",
        ...
        systems: ["Inventory"],
        image: "/images/industries/overview/imitation-jewellery.webp",
        alt: "Jewellery associate scanning pieces in organised display trays.",
      },
      {
        order: "03",
        ...
        systems: ["Inventory"],
        image: "/images/industries/overview/imitation-jewellery.webp",
        alt: "Organised imitation jewellery display in a retail store.",
      },
      {
        order: "04",
        ...
        alt: "Jewellery sales associate serving at a counter.",
      },
      {
        order: "05",
        ...
        image: "/images/industries/overview/jewellery-operations.webp",
        alt: "Jewellery team reviewing piece movement and inventory.",
      },
      {
        order: "06",

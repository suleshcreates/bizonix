...
import { LightfallBackground } from "./lightfall-background";
...
export function ProductHero() {
  return (
    <section className={`product-hero ${styles.productHero__heroSection}`}>
      {/* Approved data-stream background — do not alter. */}
      <LightfallBackground className="product-hero-lightfall" />

      <div className={styles.productHero__shell}>
        <ProductHeroCopy />

        <div className={styles.productHero__stage}>
          <div className={styles.productHero__stageGlow} aria-hidden="true" />
          ...
          <div
            className={styles.productHero__dashboard}
            role="img"
        ...
        <p className={styles.productHero__footLabel}>
          <i className={styles.productHero__footRule} aria-hidden="true" />
          Engineered for high-throughput enterprise commerce
          <i
            className={`${styles.productHero__footRule} ${styles.productHero__footRuleEnd}`}
            aria-hidden="true"
          />
        </p>
      </div>

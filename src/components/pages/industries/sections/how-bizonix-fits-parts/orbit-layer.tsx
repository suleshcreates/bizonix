import {
  connectionPoints,
  ecosystemModules,
} from "@/lib/content/industries/module-data";
...
export function OrbitLayer({
  ...
  mappedSlugs: readonly string[];
}) {
  return (
    <div className={styles.howBizonixFits__orbit}>
      <span className={styles.howBizonixFits__orbitRing} aria-hidden="true" />
      <span
        className={styles.howBizonixFits__orbitRingOuter}
        aria-hidden="true"
      />
      <span
        className={styles.howBizonixFits__orbitRingFar}
        aria-hidden="true"
      />

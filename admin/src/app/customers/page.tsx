...
export default function CustomersPage() {
  ...
  const items = [
  {
    "q": "Zudio Multi-City Rollout",
    "cat": "Fashion Retail",
    "route": "/customers/zudio",
    "status": "PUBLISHED",
    "updated": "2026-03-10"
  },
  {
    "q": "Nature Basket Omnichannel Scale",
    "cat": "Supermarket",
    "route": "/customers/natures-basket",
    "status": "PUBLISHED",
    "updated": "2026-03-05"
  },
  {
    "q": "Apollo Pharmacy Quick-Billing",
    "cat": "Healthcare",
    "route": "/customers/apollo",
    "status": "PUBLISHED",
    "updated": "2026-02-28"
  }
];
  ...
  return (
    <AdminShell>
      <PageHeader
        title="Customers"
        subtitle="Manage customer logos, case studies, testimonials, and verified proof points."
        breadcrumbs={[{ label: "Website" }, { label: "Customers" }]}
        badge={items.length}
        actions={
          <button

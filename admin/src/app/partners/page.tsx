...
export default function PartnersPage() {
  ...
  const items = [
  {
    "q": "Razorpay POS Solutions",
    "cat": "Payments",
    "route": "https://razorpay.com",
    "status": "PUBLISHED",
    "updated": "2026-03-01"
  },
  {
    "q": "PineLabs Merchant Ecosystem",
    "cat": "Hardware & Terminal",
    "route": "https://pinelabs.com",
    "status": "PUBLISHED",
    "updated": "2026-02-20"
  },
  {
    "q": "Delhivery Logistics Direct",
    "cat": "Courier & 3PL",
    "route": "https://delhivery.com",
    "status": "PUBLISHED",
    "updated": "2026-02-15"
  }
];
  ...
  return (
    <AdminShell>
      <PageHeader
        title="Partners"
        subtitle="Manage ecosystem solution partners, payment gateways, and system integrators."

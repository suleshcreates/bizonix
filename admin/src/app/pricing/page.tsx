...
export default function PricingPage() {
  ...
  const items = [
  {
    "q": "Standard Retail (Single Store)",
    "cat": "Subscription",
  ...
  {
    "q": "Multi-Store Growth (2-10 Stores)",
    "cat": "Subscription",
    "route": "/pricing#growth",
    "status": "PUBLISHED",
    "updated": "2026-03-16"
  },
  {
    "q": "Enterprise Scale (Unlimited)",
    "cat": "Custom Contract",
  ...
  return (
    <AdminShell>
      <PageHeader
        title="Pricing"
        subtitle="Manage subscription tiers, feature comparison tables, and modular add-ons."
        breadcrumbs={[{ label: "Website" }, { label: "Pricing" }]}
        badge={items.length}
        actions={
          <button

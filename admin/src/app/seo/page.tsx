...
export default function SEOMetadataPage() {
  ...
  return (
    <AdminShell>
      <PageHeader
        title="SEO & Metadata"
        subtitle="Manage OpenGraph previews, canonical paths, title templates, and meta descriptions."
        breadcrumbs={[{ label: "Growth" }, { label: "SEO & Metadata" }]}
        badge={items.length}
        actions={
          <button

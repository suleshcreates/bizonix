...
export default function NavigationPage() {
  ...
  return (
    <AdminShell>
      <PageHeader
        title="Navigation"
        subtitle="Configure public header menu, mega-menu groups, and footer link hierarchies."

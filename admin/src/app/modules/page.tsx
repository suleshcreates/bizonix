...
export default function ModulesPage() {
  ...
  {
    "q": "Automated Financial Reconciliation",
    "cat": "Finance",
  ...
  return (
    <AdminShell>
      <PageHeader
        title="Modules"
        subtitle="Manage core system modules, feature capabilities, and storefront presentation."

...
export function FinalCTA() {
  ...
  return (
    <section className="section bg-white relative overflow-hidden py-14 md:py-24">
      {/* Decorative layout grid line */}
      <div className="absolute top-0 left-0 right-0 h-px bg-slate-100" />

      <div className="shell">
        <div className="bg-gradient-to-br from-[#0b1f3a] to-[#071628] rounded-[28px] sm:rounded-[40px] lg:rounded-[48px] border border-slate-800 p-6 sm:p-10 md:p-14 lg:p-20 relative overflow-hidden shadow-2xl text-white">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="pt-2 flex flex-col sm:flex-row gap-3 [&>a]:w-full sm:[&>a]:w-auto">
                <ButtonLink
                  href="/contact"
              ...
              {/* Quick stats strip */}
              <div className="pt-7 border-t border-slate-800/80 grid grid-cols-3 gap-3">
                <div>
                  <span className="block text-lg font-bold leading-tight text-white sm:text-xl md:text-2xl">
                    100%
                  </span>
                  <span className="mt-1 block text-[9px] font-extrabold uppercase tracking-wider text-slate-500">
                    GST Compliant
                  </span>
                </div>
                <div>
            ...
            <div className="lg:col-span-5 flex justify-center">
              <div className="bg-slate-950/60 backdrop-blur-md rounded-[24px] sm:rounded-[32px] border border-slate-800/85 p-5 sm:p-6 w-full max-w-md h-[270px] overflow-hidden flex flex-col justify-between shadow-[0_24px_50px_rgba(0,0,0,0.3)] relative group">
